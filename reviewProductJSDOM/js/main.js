...
// addEventListener in our page DOMContentLoaded,load
...
function display(count) {
  ...
  img.src = products[count].images;
  name.innerHTML = products[count].title;
  designation.innerHTML = products[count].category;
  review.innerHTML = products[count].description;
...
nextbtn.addEventListener("click", () => {
    ...
    // restart showing product after finishing
...
// for showing previous product after restarting
  if(count === 0){
